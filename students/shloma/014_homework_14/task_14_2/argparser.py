...
def pomodoro_argparse():
    ...
    parser.add_argument("-p", "--pause", dest="pause", type=int, help="Breaking time (minutes)", default=4)
    parser.add_argument("-c", "--cycles", dest="cycle", type=int, help="Number of cycles", default=5)
